  ...
  return (
    <section id="contact" className="px-6 py-20">
      <div className="mx-auto max-w-5xl">
          ...
          <Reveal delay={100}>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted">+977 9861969001</p>
              </div>
            </a>
          </Reveal>
          ...
          <Reveal delay={300}>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted">Abhishek Dhakal</p>
              </div>
            </a>
          </Reveal>
        </div>
        ...
        <Reveal delay={200}>
          <a
            href="https://wa.me/9779861969001"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-8 flex items-center justify-center gap-3 rounded-xl border border-[#25d366]/40 bg-[#25d366]/10 p-5 text-center transition-all hover:bg-[#25d366]/20 hover:shadow-lg hover:shadow-[#25d366]/10"
          >
            <svg
              width="22"
              height="22"
            ...
            <span className="text-sm font-semibold text-foreground">
              Chat on WhatsApp — I usually reply within a few hours
            </span>
          </a>
        </Reveal>
